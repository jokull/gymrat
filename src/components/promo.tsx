...
import { CreateWorkoutFieldset } from "./dashboard/create-workout";
import { WorkoutRow } from "./dashboard/workouts";
...
export function Promo() {
	...
	const [promoWorkouts, setPromoWorkouts] = useState<Omit<PromoWorkout, "isTime">[]>(
		[
			{
				id: "1",
	...
	const workouts: (PromoWorkout & { maxScore: number; minScore: number })[] = promoWorkouts.map(
		(workout) => ({
			...workout,
			maxScore,
			minScore: -1,
